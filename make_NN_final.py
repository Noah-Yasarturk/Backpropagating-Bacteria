...
def main():
    ...
    fTest = 'C:/Users/nyasa/Documents/Classes/IntroML/Project/pls/Archive (1)/test/'
    #Path to where training set is stored
    fTrain = 'C:/Users/nyasa/Documents/Classes/IntroML/Project/pls/Archive (1)/Final/'
    ...
    print('Getting data....')
    get_data2(fTrain, fTest, trn_imRAs, tst_imRAs, trn_cls, tst_cls)
    ...
    model.fit(trn_imRAs, trn_lbls, epochs= 50) #100 used to work on def imgs
...
def create_model(pix, neurs):
    ...
    keras.layers.Flatten(input_shape=(pix, pix)),
    #Dense layer 1
    keras.layers.Dense(65, activation=tf.nn.relu),
    #Dense layer 2
    keras.layers.Dense(21, activation=tf.sigmoid),
...
def get_data2(fTrain, fTest, trn_imRAs, tst_imRAs, trn_cls, tst_cls):
    #Get train data
